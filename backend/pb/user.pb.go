...
type User struct {
	...
	Id        string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // Unique and primary key
	Firstname string `protobuf:"bytes,2,opt,name=firstname,proto3" json:"firstname,omitempty"`
	Lastname  string `protobuf:"bytes,3,opt,name=lastname,proto3" json:"lastname,omitempty"`
	ZoneId    string `protobuf:"bytes,4,opt,name=zoneId,proto3" json:"zoneId,omitempty"`
	Email     string `protobuf:"bytes,5,opt,name=email,proto3" json:"email,omitempty"` // Should be unique and follow email format
	Phone     string `protobuf:"bytes,6,opt,name=phone,proto3" json:"phone,omitempty"` // Should be unique, can start with '+' and contain only digits
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x22, 0xeb, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x65,
	...
	0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x1a, 0x55, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65,
	...
	0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x69, 0x74, 0x79, 0x12, 0x1e,
	0x0a, 0x0a, 0x70, 0x6f, 0x73, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x6f, 0x73, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x0c,
...
var file_user_proto_goTypes = []interface{}{
	(*User)(nil),         // 0: db.User
	(*User_Address)(nil), // 1: db.User.Address
}
